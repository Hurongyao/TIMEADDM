...
class Decoder(nn.Module):
    def __init__(self, input_size, hidden_size, dropout, seq_len, use_act=True):
...
class LSTMAE(nn.Module):
    ...
    def forward(self, x, flag, return_last_h=False, return_enc_out=False):
